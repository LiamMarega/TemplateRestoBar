        ...
        <Row className='LandingPage__Container_Row_Dos'>
          <Col xs={6} xl={12}>
            <Figure className='LandingPage__LogoBar'>
              <Figure.Image width={200} height={200} alt='171x180' src={imgBarLogo} />
              <Figure.Caption>
                <h2>Resto Bar</h2>
              </Figure.Caption>
            </Figure>
          ...
          <Col xs={12} xl={6}>
            <p>El Disco bar Food & Drink abrio sus puertas el dia 10 de julio del 2009, estamos en Posada de Rengos (al lado de la iglesia)y dista a 16 km de Cangas del Narcea.</p>
          </Col>
        </Row>
